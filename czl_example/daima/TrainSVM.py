...
def TestNN(n_features,n_classes,Datadir,ModelPath,feature):
    model=LogisticRegression(n_features=n_features,n_classes=n_classes)
    model.load_state_dict(torch.load(ModelPath))
    model.eval()
    model = model.cuda()
    if feature == "Contrast":
        test_data = MYDataset(Datadir + 'ContrastFeature.npy', Datadir + 'y.npy')
    elif feature == "AAE":
        test_data = MYDataset(Datadir + 'AAE_Features.npy', Datadir + 'y.npy')
    elif feature == "VAE":
        test_data = MYDataset(Datadir + 'VAE_Features.npy', Datadir + 'y.npy')
