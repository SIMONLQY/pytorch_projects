...
class MyDataset(Dataset):
    def __init__(self, train_path, sentence_max_size, embedding, word2id, is_train=True):
    ...
    def __getitem__(self, index):
        ...
        text = tokenize(text)
        tensor = generate_tensor(text, self.sentence_max_size, self.embedding, self.word2id)
